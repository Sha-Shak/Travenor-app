...
export default function ErrorPage() {
  ...
  return (
    <div className="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 items-center text-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
        ...
        <div className="relative">
          <div className="absolute">
            <div className="">
              ...
              <h2 className="my-2 text-gray-800">{errorMessage}</h2>
